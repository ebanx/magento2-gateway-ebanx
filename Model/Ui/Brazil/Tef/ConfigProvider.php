<?php
namespace DigitalHub\Ebanx\Model\Ui\Brazil\Tef;
...
{
    const CODE = 'digitalhub_ebanx_brazil_tef';
    ...
    public function getConfig()
    {
        ...
        return [
            'payment' => [
                'digitalhub_ebanx_brazil_tef' => [
                    'isActive' => (bool)($this->_ebanxHelper->getConfigData('digitalhub_ebanx_brazil_tef', 'active', $this->storeId) && $isActiveGlobal)
                ]
            ]
        ];
    }
