<?php
namespace DigitalHub\Ebanx\Gateway\Validator\Brazil\CreditCard;
...
class CountryValidator extends \Magento\Payment\Gateway\Validator\AbstractValidator
{
    ...
    public function validate(array $validationSubject)
    {
        ...
        if (!$isValid) {
            $this->_logger->info('Country is not BR or the store base currency is not in the available currencies');
        }
