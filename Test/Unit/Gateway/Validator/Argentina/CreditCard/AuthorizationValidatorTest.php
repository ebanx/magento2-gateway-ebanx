<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Validator\Argentina\CreditCard;
...
use DigitalHub\Ebanx\Gateway\Validator\Argentina\CreditCard\AuthorizationValidator;
...
class AuthorizationValidatorTest extends \PHPUnit\Framework\TestCase
{
    public function testSuccessWithSaveCc()
    {
        ...
        $eventManagerMock->expects($this->once())
            ->method('dispatch')
            ->with('digitalhub_ebanx_assign_argentina_creditcard_token', ['token_data' => $eventTokenData]);
    ...
    public function testHighRiskTransactionWillFilterErrorMessage()
    {
        $expectation = [];
