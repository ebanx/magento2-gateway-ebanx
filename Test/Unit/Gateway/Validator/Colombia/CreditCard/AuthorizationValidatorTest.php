...
use DigitalHub\Ebanx\Gateway\Validator\Colombia\CreditCard\AuthorizationValidator;
...
class AuthorizationValidatorTest extends \PHPUnit\Framework\TestCase
{
    public function testSuccessWithSaveCc()
    {
        ...
        $eventManagerMock->expects($this->once())
            ->method('dispatch')
            ->with('digitalhub_ebanx_assign_colombia_creditcard_token', ['token_data' => $eventTokenData]);
