<?php
namespace DigitalHub\Ebanx\Test\Gateway\Request\Colombia\Eft;
...
use DigitalHub\Ebanx\Gateway\Request\Colombia\Eft\PaymentDataBuilder;
use DigitalHub\Ebanx\Observer\Colombia\Eft\DataAssignObserver;
...
class PaymentDataBuilderTest extends \PHPUnit\Framework\TestCase
{
    public function testBuild()
    {
        ...
        $additionalData = [
            DataAssignObserver::EFT_CODE => $bankCode
        ];
