<?php
namespace DigitalHub\Ebanx\Test\Gateway\Request\Argentina\CreditCard;
...
use DigitalHub\Ebanx\Gateway\Request\Argentina\CreditCard\CancelDataBuilder;

class CancelDataBuilderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBuild()
    {
        ...
        $request = new CancelDataBuilder($ebanxHelperMock, $loggerMock);
