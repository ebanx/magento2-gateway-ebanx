<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Argentina\Rapipago;

use DigitalHub\Ebanx\Gateway\Config\Argentina\Rapipago\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'creditcard,cupondepagos,rapipago'
                ],
                'expectedResult' => true
            ],
            [
