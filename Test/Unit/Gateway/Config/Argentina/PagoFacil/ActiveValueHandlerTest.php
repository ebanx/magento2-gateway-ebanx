...
use DigitalHub\Ebanx\Gateway\Config\Argentina\PagoFacil\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'pagofacil,rapipago,creditcard'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'creditcard,pagofacil,rapipago'
                ],
                'expectedResult' => true
            ],
            [
