<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Peru\PagoEfectivo;

use DigitalHub\Ebanx\Gateway\Config\Peru\PagoEfectivo\ActiveValueHandler;
    ...
    public function testHandle($expectedConfig, $expectedResult)
    {
        ...
        $ebanxHelper->expects($this->any())
            ...
            ->withConsecutive(
                ...
                ['digitalhub_ebanx_global', 'payments_peru', $storeId]
            )
    ...
    public function handleDataProvider()
    {
        return [
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'safetypay,pagoefectivo'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'pagoefectivo'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'safetypay'
                ],
