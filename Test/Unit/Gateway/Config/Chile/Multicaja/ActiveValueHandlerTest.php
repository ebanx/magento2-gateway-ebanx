<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Chile\Multicaja;

use DigitalHub\Ebanx\Gateway\Config\Chile\Multicaja\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'servipag'
                ],
