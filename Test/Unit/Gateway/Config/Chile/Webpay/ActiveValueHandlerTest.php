...
use DigitalHub\Ebanx\Gateway\Config\Chile\Webpay\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'servipag,webpay,sencillito'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'multicaja,servipag,webpay'
                ],
                'expectedResult' => true
            ],
            [
