<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Chile\Servipag;

use DigitalHub\Ebanx\Gateway\Config\Chile\Servipag\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'multicaja,servipag'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'sencillito'
                ],
