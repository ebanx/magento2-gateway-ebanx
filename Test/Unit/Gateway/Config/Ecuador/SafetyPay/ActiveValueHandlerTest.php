<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Ecuador\SafetyPay;

use DigitalHub\Ebanx\Gateway\Config\Ecuador\SafetyPay\ActiveValueHandler;
    ...
    public function testHandle($expectedConfig, $expectedResult)
    {
        ...
        $ebanxHelper->expects($this->any())
            ...
            ->withConsecutive(
                ...
                ['digitalhub_ebanx_global', 'payments_ecuador', $storeId]
            )
