<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Mexico\Spei;

use DigitalHub\Ebanx\Gateway\Config\Mexico\Spei\ActiveValueHandler;
    ...
    public function testHandle($expectedConfig, $expectedResult)
    {
        ...
        $ebanxHelper->expects($this->any())
            ...
            ->withConsecutive(
                ...
                ['digitalhub_ebanx_global', 'payments_mexico', $storeId]
            )
    ...
    public function handleDataProvider()
    {
        return [
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'oxxo,creditcard,spei'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'oxxo,spei'
                ],
                'expectedResult' => true
            ],
            [
