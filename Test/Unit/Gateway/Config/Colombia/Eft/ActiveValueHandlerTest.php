<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Colombia\Eft;

use DigitalHub\Ebanx\Gateway\Config\Colombia\Eft\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'baloto,eft'
                ],
                'expectedResult' => true
            ],
            [
