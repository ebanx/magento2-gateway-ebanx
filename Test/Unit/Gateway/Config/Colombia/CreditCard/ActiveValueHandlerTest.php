<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Colombia\CreditCard;

use DigitalHub\Ebanx\Gateway\Config\Colombia\CreditCard\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'eft,creditcard'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'baloto'
                ],
