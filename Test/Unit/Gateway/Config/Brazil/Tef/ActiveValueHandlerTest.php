<?php
namespace DigitalHub\Ebanx\Test\Unit\Gateway\Config\Brazil\Tef;

use DigitalHub\Ebanx\Gateway\Config\Brazil\Tef\ActiveValueHandler;
    ...
    public function handleDataProvider()
    {
        return [
            ...
            [
                'expectedConfig' => [
                    'storeId' => 2,
                    'config_enabled_payments' => 'boleto,tef'
                ],
                'expectedResult' => true
            ],
            [
                'expectedConfig' => [
                    'storeId' => 1,
                    'config_enabled_payments' => 'boleto,creditcard'
                ],
